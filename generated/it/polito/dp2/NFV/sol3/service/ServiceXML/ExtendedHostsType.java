 ...
 *       &lt;sequence>
 *         &lt;element name="host" type="{http://www.example.com/nfv}extendedHostsType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ExtendedHostsType {
    ...
    protected List<ExtendedHostsType> host;
     ...
     * {@link ExtendedHostsType }
     * 
     * 
     */
    public List<ExtendedHostsType> getHost() {
        if (host == null) {
            host = new ArrayList<ExtendedHostsType>();
        }
        return this.host;
    }
