...
public class ObjectFactory {
    ...
    private final static QName _Function_QNAME = new QName("http://www.example.com/nfv", "function");
    ...
    private final static QName _Nodes_QNAME = new QName("http://www.example.com/nfv", "nodes");
    ...
    /**
     * Create an instance of {@link RestrictedNodeType }
     * 
     */
    public RestrictedNodeType createRestrictedNodeType() {
        return new RestrictedNodeType();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.com/nfv", name = "function")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.com/nfv", name = "nodes")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RestrictedNodeType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.com/nfv", name = "node")
    public JAXBElement<RestrictedNodeType> createNode(RestrictedNodeType value) {
        return new JAXBElement<RestrictedNodeType>(_Node_QNAME, RestrictedNodeType.class, null, value);
    }
